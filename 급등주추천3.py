...
# 학습된 bert 감성분석 모델로 buy_list, 코스피200, 코스닥150에 있는 종목들에 대해 최근 5개의 구글링 뉴스를 추론하여 매수 여부를 결정한다.

# 급등주추천2와의 차이는 모델을 새로 build한 후 이전 훈련 과정에서 save된 weigh만 다시 load하여 추론한다.
...
if __name__ == "__main__":
    ...
    reloaded_model.load_weights('model_weights.h5')
